...
|---|---|---:|---|
| Program | Democratic Resilience & AI Literacy Program | 1.0 | važeći programski okvir |
...
| Institutional Response Quality | CF-IRQF | 0.1 | horizontalni okvir — kandidat u validaciji |
| Administrative Response & Closure Monitor | CF-ARCM | 0.1 | domenski modul — kandidat u validaciji |
| Justice Accountability Response Monitor | CF-JARM | 0.1 | domenski modul — kandidat u validaciji |
| Civic Decision Engine | KAIT/CDE specifikacija | 0.1 | istraživački prototip |
| Edukacija | modularni program | — | u razvoju |

## Hijerarhija

1. Program određuje misiju, principe i etičke granice.
...
Stvarni predmeti korišteni za internu kalibraciju CF-IRQF/ARCM/JARM nisu dio javnog metodološkog paketa. Osjetljivi testni podaci se ne objavljuju; javni benchmark može koristiti sintetičke ili posebno odobrene anonimizovane slučajeve.
